...
/* Abajur fiyat tarifesi — TEK düzenleme noktası.
   Konfigüratör bu tabloyu /api/abajur-price üzerinden çeker, dolayısıyla
   burada yapılan değişiklik hem müşteriye gösterilen fiyatı hem de sipariş
   anında sunucuda doğrulanan fiyatı aynı anda değiştirir. */
export const ABAJUR_FIYAT = {
  ...
  /* Efektif baskı akışı (mm³/s) — baskı süresini, dolayısıyla makine
     ...
     Kalibre etmek için: bir STL'i Bambu Studio'da dilimle, çıkan gerçek
     süreyi not et, sonra  akis = hacim(cm³) x 1000 / (süre_saat x 3600).
     Düşük değer = uzun süre varsayımı = yüksek fiyat. */
  akisMm3s: 4,
  elIsciligi: 60,
  boyunMontaj: 45,
  duy: { E27: 180, E14: 150 },
